 ...
 * NB : 1,6,12,12,12,12,12,48,24,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,60,48,48
 */
...
{ \
   ...
   else if ((n_) < 225) (nb_) = 48; \
   else if ((n_) < 275) (nb_) = 24; \
   else if ((n_) < 3000) (nb_) = 48; \
   else if ((n_) < 3400) (nb_) = 60; \
   else (nb_) = 48; \
}
