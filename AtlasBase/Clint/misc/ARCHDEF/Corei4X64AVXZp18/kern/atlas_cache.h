...
#define L3C_SURE 1
#ifdef SREAL
   #define L3C_ELTS 202752L
   #define L3C_LSELTS 16
#elif defined(DREAL) || defined(SCPLX)
   #define L3C_ELTS 101376L
   #define L3C_LSELTS 8
#elif defined(DCPLX)
   #define L3C_ELTS 50688L
   #define L3C_LSELTS 4
#endif
...
#define LLC_SZ 843776L
#ifdef SREAL
   #define LLC_ELTS 464896L
#elif defined(DREAL) || defined(SCPLX)
   #define LLC_ELTS 232448L
#elif defined(DCPLX)
   #define LLC_ELTS 116224L
#endif
