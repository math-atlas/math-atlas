...
in math-atlas_ .. |emdash| excellent!
...
::
   ...
   git clone git://github.com/math-atlas/math-atlas.git
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `math-atlas mailing list`_.
...
Fork the math-atlas_ repository on github_ |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/math-atlas.git
