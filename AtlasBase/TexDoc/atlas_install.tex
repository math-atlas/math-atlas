...
(such as GNU/Linux or OS~X).  Without architectural defaults installs
typically take most of a day.  To avoid this, I hope to create a tarfile
of user-generated Windows Architectural defaults, which can be found in
the errata file.
