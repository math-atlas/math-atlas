...
#include <math.h>
#include "atlas_misc.h"    /* to manage the ATL TYPE*/
...
/*
 * Majedul: to test nrm2, I added all the stubs functions and everything without
 * SSQ. I will get SSQ from ifko ...
 * Here are all the stub functions..
 */
/*****************************************************************************/
