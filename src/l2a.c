 ...
 */
      case VDCMOV1:
               ...
               if (op2 < 0) /* only src2(here op2) can be mem */
                  ap->next = PrintAssln("\tvblendvpd\t%s,%s,%s,%s\n", 
	                                archfregs[-VDREGBEG-op3],
                                        archfregs[-VDREGBEG-op2],
	                                archfregs[-VDREGBEG-op1],
	                                archfregs[-VDREGBEG-op1]);
               else
                  ap->next = PrintAssln("\tvblendvpd\t%s,%s,%s,%s\n", 
	                                archfregs[-VDREGBEG-op3],
 ...
 */
      case VFCMPWEQ:
            ...
            ap->next = PrintAssln("\tcmpps\t$0,%s,%s\n",  
                          archvfregs[-VFREGBEG-op3], archvfregs[-VFREGBEG-op1]);
         #endif 
         break;
      case VFCMPWNE:
         #ifdef AVX
 ...
 */
      ...
      case VDCMPWEQ:
            ...
            ap->next = PrintAssln("\tcmppd\t$0,%s,%s\n",  
                          archvdregs[-VDREGBEG-op3], archvdregs[-VDREGBEG-op1]);
         #endif 
         break;
      case VDCMPWNE:
         #ifdef AVX
