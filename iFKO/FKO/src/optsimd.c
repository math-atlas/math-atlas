 ...
 */
      ...
      /*fko_error(__LINE__, 
            "should have one load to broadcast!!! double check!");*/
...
#if 0      
      fprintf(stderr, "lvl(%d) : ", lvl[0]);
      for (i=1; i <= nway; i++)
         fprintf(stderr, "%d ", lvl[i]);
      fprintf(stderr, "\n");
#endif
